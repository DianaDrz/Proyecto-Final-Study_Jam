...
public class Main2Activity extends AppCompatActivity {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    EstructuraFragment estructuraFragment=new EstructuraFragment();
                    return estructuraFragment;
                case 1:
                    PosicionesFragment posicionesFragment=new PosicionesFragment();
                    return posicionesFragment;
                case 2:
                    AfinacionFragment afinacionFragment=new AfinacionFragment();
                    return afinacionFragment;
                default:
                    return null;
            }
